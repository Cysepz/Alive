...
import com.cysepz.alive.repository.CheckInRepository;
...
public class CheckInService {
    ...
    public int checkIn(Long userId) {
        ...
        checkInRepository.checkInByUserId(userId, newBitmap);

        return getMonthlyBitmap(userId);
    }

    public int getMonthlyBitmap(Long userId) {
        return checkInRepository.findMonthlyBitmapByUserId(userId);
    }
}
